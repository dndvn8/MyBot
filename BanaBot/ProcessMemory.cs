    ...
    internal class ProcessMemory
    {
        ...
        public bool StartProcess()
        {
            if (this.ProcessName != "")
            {
                ...
                {
                    MessageBox.Show(this.ProcessName + " is not running or has not been found. Please check and try again", "Process Not Found", MessageBoxButton.OK, MessageBoxImage.Hand);
                    return false;
                }
